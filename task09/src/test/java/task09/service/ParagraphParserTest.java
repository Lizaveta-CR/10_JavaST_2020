...
public class ParagraphParserTest {
    private ParagraphParser parser = new ParagraphParser(new SentenceParser(new LexemeParser(new WordParser(new CharacterParser()))));
    private String text;
    ...
    public Object[] createCorrectData() {
        return new Object[]{
                "\t\tIt has survived not only five centuries, but also the leap into electronic typesetting, "
                        + "remaining essentially unchanged. It was popularised in the with there lease of Letraset "
                        + "sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like "
                        + "Aldus PageMaker including versions of Lorem Ipsum.\n" +
                        "\t\tIt is a long established fact that a reader will be distracted by the readable content of "
                        + "a page when looking at its layout. The point of using Ipsum is that it has a more-or-less "
    ...
    public void testCollect(String compos) {
        ...
        Composite composite = parser.parse(compositeParagraph, text);
