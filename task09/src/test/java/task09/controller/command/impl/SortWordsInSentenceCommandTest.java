...
public class SortWordsInSentenceCommandTest {
    private SortWordsInSentenceCommand sort = new SortWordsInSentenceCommand();
    ...
    public void testCollectWithNumbers() {
        ...
        strings.add(CommandName.WORDS_IN_SENTENCE.name());
