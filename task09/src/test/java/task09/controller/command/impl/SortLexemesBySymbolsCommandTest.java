...
public class SortLexemesBySymbolsCommandTest {
    private SortLexemesBySymbolsCommand sort = new SortLexemesBySymbolsCommand();
    ...
    public void testCollectWithNumbers() {
        ...
        strings.add(CommandName.SORT_LEXEMES_SYMBOLS.name());
