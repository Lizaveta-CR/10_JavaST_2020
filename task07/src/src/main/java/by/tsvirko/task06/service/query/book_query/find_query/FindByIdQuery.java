...
public class FindByIdQuery implements Query<Book, PublicationStorage> {
    private String id;
    ...
    @Override
    public List<Book> query(PublicationStorage storage) throws FindException, NoAuthorsException, BookStorageElementException {
