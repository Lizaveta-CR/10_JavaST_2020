...
public interface Query<Entity, EntityStorage> {
    List<Entity> query(EntityStorage storage) throws FindException, NoAuthorsException, BookStorageElementException, by.tsvirko.task06.service.query.publication_query.find_query.exception.FindException;
}
